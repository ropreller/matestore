...
const CarritoIcono = (props) => {
    ...
    return (
        <>
            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" className="bi bi-minecart-loaded" viewBox="0 0 16 16">
            ...
            <Badge bg="secondary">{(props.items>0) ? props.items : 'Vacío'}</Badge>
        </>
    )
}
